...
var TokenStrategy = /** @class */ (function (_super) {
    __extends(TokenStrategy, _super);
    function TokenStrategy(authService) {
    ...
    TokenStrategy.prototype.validate = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                user = this.authService.findUserByToken(token);
                if (user === null) {
...
}(passport_1.PassportStrategy(passport_http_bearer_1.Strategy)));
