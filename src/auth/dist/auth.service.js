    ...
    AuthService.prototype.createToken = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokenGenerate = crypto.randomBytes(32);
                        tokenString = tokenGenerate.toString('hex');
                        token = new token_entity_1["default"]();
                        token.user = user;
                        token.token = tokenString;
                        return [4 /*yield*/, this.dataSource.getRepository(token_entity_1["default"]).insert(token)];
                    case 1:
                        _a.sent();
