...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.login = function (loginData) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepo, user, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userRepo = this.dataSource.getRepository(user_entity_1["default"]);
                        return [4 /*yield*/, userRepo.findOneBy({ email: loginData.email })];
                    case 1:
                        user = _b.sent();
                        if (user === null) {
                    ...
                    case 2:
                        ...
                        _a = {};
                        return [4 /*yield*/, this.authService.createToken(user)];
